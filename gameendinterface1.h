#ifndef GAMEENDINTERFACE1_H
#define GAMEENDINTERFACE1_H
...
class GameEndInterface1:public QGraphicsView{
    Q_OBJECT
private:
    QString MusicDir;
    QString ImageDir;
public:
    ...
    explicit GameEndInterface1(QWidget *parent = 0);
